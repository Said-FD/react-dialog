  ...
  return (
    <>
      ...
      <Dialog
        ...
        escKeyAction={handleEscKey}
        dialogCloseAction={handleDialogClose}
        ...
        // innerClassNames="some-class-name"
        // headerClassNames="some-class-name"
        // titleClassNames="some-class-name"
        // closeButtonClassNames="some-class-name"
        // bodyClassNames="some-class-name"
        // footerClassNames="some-class-name"
        // confirmButtonClassNames="some-class-name"
        // cancelButtonClassNames="some-class-name"
      ...
      >
        ...
        <p style={{ textWrap: 'balance' }}>
          Now you can use all benefits of the native <code>&lt;dialog /&gt;</code> element!
        </p>
        <p>
          To open next dialog
          <button
